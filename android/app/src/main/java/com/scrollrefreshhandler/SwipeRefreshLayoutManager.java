...
public class SwipeRefreshLayoutManager extends ViewGroupManager<ReactSwipeRefreshLayout>
    ...
    public static final String REACT_CLASS = "AndroidSwipeRefreshLayoutCustom";
    ...
    public void setSize(ReactSwipeRefreshLayout view, String size) {
        if (size == null || size.equals("default")) {
            view.setSize(SwipeRefreshLayoutLottie.DEFAULT);
        } else if (size.equals("large")) {
            view.setSize(SwipeRefreshLayoutLottie.LARGE);
        } else {
    ...
    protected void addEventEmitters(
        ...
        SwipeRefreshLayoutLottie.OnRefreshListener listener = new SwipeRefreshLayoutLottie.OnRefreshListener() {
            @Override
    ...
    public Map<String, Object> getExportedViewConstants() {
        return MapBuilder.<String, Object>of(
                "SIZE",
                MapBuilder.of("DEFAULT", SwipeRefreshLayoutLottie.DEFAULT, "LARGE", SwipeRefreshLayoutLottie.LARGE));
    }
