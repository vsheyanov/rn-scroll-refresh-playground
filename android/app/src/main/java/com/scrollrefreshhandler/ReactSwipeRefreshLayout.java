...
/** Basic extension of {@link SwipeRefreshLayoutLottie} with ReactNative-specific functionality. */
public class ReactSwipeRefreshLayout extends SwipeRefreshLayoutLottie {

    private static final float DEFAULT_CIRCLE_TARGET = 104;
    ...
    /**
     * {@link SwipeRefreshLayoutLottie} overrides {@link ViewGroup#requestDisallowInterceptTouchEvent} and
    ...
    /**
     * {@link SwipeRefreshLayoutLottie} completely bypasses ViewGroup's "disallowIntercept" by overriding
