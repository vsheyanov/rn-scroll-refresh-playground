 ...
 * </p>
 */
public class SwipeRefreshLayoutLottie extends ViewGroup implements NestedScrollingParent,
    ...
    @VisibleForTesting
    static final int CIRCLE_DIAMETER = 140;
    @VisibleForTesting
    static final int CIRCLE_DIAMETER_LARGE = 56;

    private static final String LOG_TAG = SwipeRefreshLayoutLottie.class.getSimpleName();
    ...
    SwipeRefreshLayoutLottie.OnRefreshListener mListener;
    ...
    private SwipeRefreshLayoutLottie.OnChildScrollUpCallback mChildScrollUpCallback;
...
//        mCircleView.setImageDrawable(mProgress);
     ...
     * @param context
     */
    public SwipeRefreshLayoutLottie(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwipeRefreshLayoutLottie(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
...
//        mProgress.setStyle(CircularProgressDrawable.DEFAULT);
     ...
     * gesture.
     */
    public void setOnRefreshListener(@Nullable SwipeRefreshLayoutLottie.OnRefreshListener listener) {
        mListener = listener;
    }
    ...
    /**
     * Set a callback to override {@link SwipeRefreshLayoutLottie#canChildScrollUp()} method. Non-null
     * callback will return the value provided by the callback and ignore all internal logic.
     * @param callback Callback that should be called when canChildScrollUp() is called.
     */
    public void setOnChildScrollUpCallback(@Nullable SwipeRefreshLayoutLottie.OnChildScrollUpCallback callback) {
    ...
    void setTargetOffsetTopAndBottom(int offset) {
        Log.d(LOG_TAG, "printing" + offset + mRefreshing);
    ...
    /**
     * Classes that wish to override {@link SwipeRefreshLayoutLottie#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link SwipeRefreshLayoutLottie#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(@NonNull SwipeRefreshLayoutLottie parent, @Nullable View child);
    }
}
